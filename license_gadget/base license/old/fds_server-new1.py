...
def start_server():
    ...
    context.minimum_version = ssl.TLSVersion.SSLv3  # Allow SSLv3 for testing
    context.maximum_version = ssl.TLSVersion.TLSv1_3  # Allow up to TLS 1.3
    # Use all available ciphers supported by OpenSSL
    ...
    while True:
        try:
            ...
            try:
                ...
                print(f"[-] SSL Error: {e}")
                print(f"[-] SSL Error Details: {e.__dict__}")
                client_socket.close()
        except Exception as e:
